...
class RewriteResponse(BaseResponse):
    ...
    def _rewrite(self,sessionid_in):
        ...
        #         'label2entities_cur_dict': label2entities_cur_dict,'flag_interaction':flag_inter,'abbrev2std_list':abbrev2std_list}

        return { 'flag_interaction': flag_inter,
                ...
                'abbrev2std_list': abbrev2std_list,
                 'abbrev':abbrev_str
                }
